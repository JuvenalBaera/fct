...
//        timer = null;
    ...
    private void initComponents() {
        ...
        jToggleButton1All = new javax.swing.JToggleButton();
        ...
        jPanelMessage.setMaximumSize(new java.awt.Dimension(470, 60));
        jPanelMessage.setMinimumSize(new java.awt.Dimension(156, 38));
        jPanelMessage.setPreferredSize(new java.awt.Dimension(470, 70));
        ...
        jPanelMessage.add(jToggleButtonRecord);

        jToggleButton1All.setText("All");
        jToggleButton1All.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jToggleButton1AllActionPerformed(evt);
            }
        });
        jPanelMessage.add(jToggleButton1All);
...
//          ...
    ...
    private void jToggleButton1AllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1AllActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jToggleButton1AllActionPerformed
    ...
    public synchronized void send_packet() {
        ...
        try {
            ...
            // EX C
            if (jToggleButton1All.isSelected()) {
                //String subnet = "172.16.54.";
                String host = InetAddress.getLocalHost().getHostAddress();
                int index = host.lastIndexOf('.');
                String subnet = host.substring(0, index+1); // XX.XX.XX.
                
                int start_ip = 1;//101;
                for (int i = start_ip; i < start_ip + 255; i++) {
                    host = subnet + i;
                    InetAddress inet = InetAddress.getByName(host);
                    send_one_packet(dp, inet, port, message);
                }
    ...
    private javax.swing.JToggleButton jToggleButton1All;
